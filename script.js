document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function showFieldError(field, message) {
      ...
      const wrapper = field.closest('.form-group, .field-wrapper, .input-wrap');
      if (wrapper) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '007506ee-eb61-4161-a79a-4ef2f0802b3a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '007506ee-eb61-4161-a79a-4ef2f0802b3a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '007506ee-eb61-4161-a79a-4ef2f0802b3a';
